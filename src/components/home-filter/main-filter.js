  ...
  return (
    <>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="search-box">
            ...
            <div className="search-filter">
              ...
              <select onChange={(e) => setMinBedrooms(e.target.value)} required>
                {" "}
          ...
          <div className="search-box">
            ...
            <div className="slider">
              ...
              <Space
                ...
                direction="vertical"
              >
                <IntegerStep onSliderChange={SetGrowthInPropertyWeightage} />
              </Space>
            </div>
            <div className="slider">
              ...
              <Space
                ...
                direction="vertical"
              >
                <IntegerStep onSliderChange={setRentVsOwnerRatioWeightage} />
              </Space>
            </div>
            <div className="slider">
            ...
            <div className="slider">
              ...
              <Space
                ...
                direction="vertical"
              >
                <IntegerStep onSliderChange={setPopulationGrowthWeightage} />
              </Space>
            </div>
            <div className="slider">
            ...
            <div className="slider">
              ...
              <Space
                ...
                direction="vertical"
              >
                <IntegerStep onSliderChange={setUnemployedPeopleWeightage} />
              </Space>
            </div>
            <div className="slider">
      ...
      <div className="results-main-container">
        <FilterResults
          results={results}
          isBedroomsUnsure={isBedroomsUnsure}
