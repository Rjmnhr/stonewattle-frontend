  ...
  (async () => {
    ...
    Highcharts.mapChart("container", {
      ...
      accessibility: {
        ...
        description:
          "Map of Australia, showing examples of multiple geometry types in Highcharts Maps: Map areas (used for regions), map lines (used for rivers), and map points (used for cities).",
      },
